            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  padding: EdgeInsets.all(16),
                  decoration: BoxDecoration(color: AppColor.white, borderRadius: BorderRadius.circular(20)),
                  height: global.show == false ? Get.height * 0.5 : Get.height * 0.15,
                  width: Get.width,
                  margin: EdgeInsets.symmetric(vertical: Get.height * 0.03),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          icon: Icon(global.show ? Icons.keyboard_arrow_up_outlined : Icons.keyboard_arrow_down_outlined, color: AppColor.black, size: Get.width * 0.07),
                        ),
                      ),
                      Divider(),
                      global.show == false
                          ? Column(
                              children: [
                                ...
                                DropdownButton<String>(
                                  ...
                                  value: global.selectedValuethree,
                ...
                CustomBtn(
                    ...
                    onPressed: () {
                      if (formKey.currentState!.validate()) {
                        Get.to(
                          SelectSeatScreen(
                              title: widget.title, trailing: widget.trailing, leading: widget.leading, trailingtwo: widget.trailingtwo, date: widget.date, subtitle: widget.subtitle, image: widget.image, email: global.email.text, name: global.fullName.text, phonenumber: global.country.isEmpty ? "+91${global.numberController.text}" : "+ ${global.country + global.numberController.text}"),
                        );
                      }
                    })
              ],
