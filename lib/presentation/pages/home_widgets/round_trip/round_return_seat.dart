...
import 'package:railify_app/presentation/pages/home_widgets/round_trip/round_select_payment.dart';
...
class RoundReturnSeat extends StatefulWidget {
  final String image;
  final String title;
  ...
  @override
  State<RoundReturnSeat> createState() => _RoundReturnSeatState();
}

class _RoundReturnSeatState extends State<RoundReturnSeat> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(AppString.selectseatforreturn),
        centerTitle: true,
      ),
              ...
              SizedBox(
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) => index == 2 || index == 7 || index == 12 || index == 17 || index == 22 || index == 27 || index == 32
                      ...
                      : index == 0 || index == 1 || index == 4 || index == 6 || index == 8 || index == 9 || index == 13 || index == 16 || index == 15 || index == 19 || index == 20 || index == 23 || index == 24 || index == 25 || index == 29 || index == 30 || index == 31 || index == 33
                          ? Container(
            ...
            onPressed: () {
              Get.to(
                RoundSelectPayment(
                    ...
                    email: widget.email,
                    seat: widget.seat,
                    seattwo: globle.select.toString()),
              );
            },
          ),
        ),
